...
\begin{examples}
    ...
    \words sóso kaxáxíkoi\MC3 atah sóh tà xíxíxí\MC2 kókihíkixí\MC2 kàahxí\MC2 koíháaxíkóa\MC3
    \bits sóso kaxá -xí =koi atah sóh tà xíxí -xí kókihíki -xí kàah -xí koíháa -xí =kóa  
