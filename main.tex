...
\newleipzig{qu}{Q}{interrogative mode}
...
\newleipzig{tsn}{3sn}{third person singular neuter}
...
\newleipzig{demprox}{dem:prox}{proximal demonstrative}
\newleipzig{demdist}{dem:dist}{distal demonstrative}
\newleipzig{hort}{hort}{hortative}
\newleipzig{nec}{nec}{necessity modal}

\glsfindwidesttoplevelname[\leipzigtype]

\title{A Grammar of lang5}
\author{Jacob Menschel}
\date{May 2020}
...
\newbaarucmd{\cl}{\baarujuncture{\texttt{==}}}
\ex \label{ex:perl1}
\words tàahopí há hááháahká\MC4 ókoíhtah\MC4
...
\words tà hóíkatah\MC2 háahoò\MC4 xóatiho\MC3 haíhosoaho\MC3 há
...
\words hao akahííopa ahóikahàòkóa\MC5 hikoíípahahì\MC2 \\ {apíhaiha koa}\MC2 hakó
...
\begin{examples}
    ...
    \ex \label{ex:exitr3}
    \words hao háahaka\MC3 paatihóo\MC2
...
\begin{examples}
    \ex \label{ex:aux1}
    \words hóh\MC2 kìkahoó\MC2 hóikai\MC2 toóxíkóa\MC4 ii tàah kòà ákiihi\MC2 kiixíi\MC4 há
...
\begin{examples}
    \ex \label{ex:complv1}
    \words kóíhihóo\MC2 ahá háahákoo\MC2 atàa\MC2 kóhii káixoáh\MC2 áatóhikóa\MC3
...
\begin{examples}
    \ex \label{ex:complv2}
    \words `kóíhihóo\MC2 ahá háahákoo\MC2 atàa'\MC2 ko káixoáh\MC2 áatóhikóa\MC3
