...
\subsubsection{Antipassive}\label{s:antip}
...
\end{examples}
\subsubsection{Passive}\label{s:pass}
...
\end{examples} 
\subsubsection{Causative}\label{s:caus}
...
\begin{examples}
    \ex \label{ex:caus5}
    \words [kìhaóxí]ₒ\MC2 haíhíkihikókóa\MC5 [pàahtah]ₒ\MC2
...
\begin{table}[H]
    ...
    \ref{s:recpast} & -xí   & {\Rpasto}  & \begin{tabular}[c]{@{}p{5cm}@{}}\makecell[lt]{day of speech \\ before speech time}\end{tabular} & unspecified                                                \\
    ...
    \label{t:pasttenses}
    \end{table}
\subsubsection{Recent Past}\label{s:recpast}
The recent past is used for events that have occurred on the same day on which the clause containing it is uttered. 
\subsubsection{Intermediate Past}\label{s:intpast}
\subsubsection{Distant Past}\label{s:distpast}
\subsubsection{Remote Past}\label{s:rempast}
\begin{comment}
