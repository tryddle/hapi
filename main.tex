...
\newleipzig{cntrf}{cntrf}{counterfactual}
...
Stop & p\textasciitilde b & t\textasciitilde r & k\textasciitilde g \\
Fricative & h & s\textasciitilde ts & ʃ\textasciitilde ʂ\textasciitilde χ \\ \bottomrule
\end{tabular}
...
\newline
/p\textasciitilde b/ is a voiceless or voiced bilabial stop. It is pronounced as /b/ by most children and women, while it is pronounced /p/ by most men and the elderly. It appears in both word-initial and word-medial position. Henceforth it will be standardized to /p/.
...
/t\textasciitilde r/ is a voiceless alveolar stop or a voiced alveolar trill. It is pronounced as /r/ by most children and women, while it is pronounced /t/ by most men and the elderly. It appears in both word-initial and word-medial position. Henceforth it will be standardized to /t/.
...
/k\textasciitilde g/ is a voiceless or voiced velar stop. It is pronounced as /g/ by most children and women, while it is pronounced /k/ by most men and the elderly. It appears in both word-initial and word-medial position.  Henceforth it will be standardized to /k/.
...
/s\textasciitilde ts/ is a voiceless alveolar fricative or affricate. It is pronounced as /s/ by most children and women, while it is pronounced /ts/ by most men and the elderly, especially in emphasized speech. 
...
/ʃ\textasciitilde ʂ\textasciitilde χ/ is a voiceless alveolar or retroflex or uvular fricative. It is pronounced as /ʃ/ by most children, as /ʂ/ by most women and the elderly, and as /χ/ by men and in emphasized speech. It is sometimes debuccalized to /h/ in rapid speech. It appears in world-initial and word-medial position. Henceforth, it will be standardized to /ʂ/
...
\ex \phonc{ʂ}{h}{
    \oneof{
    V₁ \phold V₂ \\
    \textit{[ʃ\textasciitilde ʂ\textasciitilde χ] elsewhere}}
    }
\end{examples}
...
\bits {hó\textasciitilde hóika} =ííxi koí -∅ h- ò póói -i xósóó -xí -∅ =kóa hápaáh -h 
...
\words tài xàa hóh há kóóha\MC2 xàa kaaihò\MC2 áahikóa\MC3
\bits tài xàa hóh há kóó -a xàa kaai -ò áa -hi =kóa 
\gloss DEM:PROX COP man EGO C ST COP sick CL:anim.sg say RPASTT DECL
\tr This (pointing at man) is the man who said (of himself) that he was sick
% lit.: This is the man, he said he was sick.
...
A prominent usage of classifiers in the Hapi language is classifier possession. This construction is only one of several possessive constructions.\footnote{cf. section \ref{snposs}} The examples (\ref{ex:clsyndistr1}) - (\ref{ex:clsyndistr3}) show the general structure of such constructions. Right after the possessee, the classifier follows its head, before the possessor is introduced to the phrase. 
\begin{examples}
\newbaarucmd{\cl}{\baarujuncture{\texttt{==}}}
\ex \label{ex:clsyndistr1}
\words haí hápaáh\MC2 ò táosiihó haxápií\MC2 xósóóhió\MC4 xah sóxiihió[...]\MC4 
\bits haí hápaáh -h ò táosiihó haxápií -∅ xósóó -hi -∅ \cl ó xah sóxii -hi -∅ \cl ó 
\gloss thus dog ERG CL:anim.sg male.cousin stranger ABS bite RPASTT ST SEQ FOURTH scream RPASTT ST SEQ
...
This section is work-in-progress
\end{examples}
\subsubsection{Possessives}\label{snposs}
The main strategy for possessives in the Hapi language is depicted in the examples (\ref{ex:nposs1}) and (\ref{ex:nposs2}). In this construction, the linking disjunct affix \emh{=à} is attached to the head, followed by the possessor in the absolutive case. 
\begin{examples}
\baarucols2
\ex \label{ex:nposs1}
...
\begin{examples}
    \ex \label{ex:complv1}
    \words kóíhihóo\MC2 ahá háakaíhákoo\MC3 atàa\MC2 kóhii káixoáháh\MC3 áatóhikóa\MC3
    \bits kóíhi -hóo ahá háa= kaí= hákoo a- tàa kóhii káixo -áh -áh áa -tóhi =kóa
    \gloss forest LOC alone go NEG OBLIGATIVE PASS AUX C mother AUG ERG say DPASTO DECL
...
\begin{examples}
    \ex \label{ex:complv2}
    \words `kóíhihóo\MC2 ahá háakaíhákoo\MC3 atàa'\MC2 ko káixoáháh\MC3 áatóhikóa\MC3
    \bits kóíhi -hóo ahá háa= kaí= hákoo a- tàa ko  káixo -áh -áh áa -tóhi =kóa
    \gloss forest LOC alone go NEG OBLIGATIVE PASS AUX QUOTATIVE mother AUG ERG say DPASTO DECL
...
\begin{examples}
    \ex \label{ex:future1}
    \words sóíha kaai àihipa\MC2 páhisòì\MC2 \\ íhahihokóa\MC6 póxihoo sóóhai\MC2 sóíhi\MC2 ípítóhikóa\MC4
...
\end{examples}
It may also be used in a relative sense, encoding events that took place in the future from a past tense reference time. This usage is depicted in (\ref{ex:future2}).
\begin{examples}
    \ex \label{ex:future2}
    \words páhpi pàh xòih tópóihí\MC2 óatóhikóa\MC3 `sóasihá\MC2 kííkíípaáho\MC3 \\ akíípaáhokóa'\MC5 ko 
    \bits páhpi pàh xòih tópói =í óa -tóhi =kóa sóasih =á {kíí\textasciitilde kíípaá} -h -o a- kíípaá -h -o =kóa ko
    \gloss bread CL:flat brother chew \textsc{\textup{s/a>s(se)}} think DPASTO DECL spirit VOC REDUP:kill 1 FUT RECIP kill 1 FUT DECL QUOTATIVE
    \tr While chewing on my brother's flatbread, he thought: ``Oh spirits, I will avenge (those who have fallen)!''
\end{examples}
The future tense also appears in the apodosis part of certain conditional sentences, namely those in which a realizable condition is expressed. An example for this usage of the future tense marker is shown in \ref{ex:future3}.
\begin{examples}
    \newbaarucmd{\cl}{\baarujuncture{\texttt{==}}}
    \ex \label{ex:future3}
    \words páótaíta\MC2 xah ákiihkóa\MC3 xahataxa\MC2 kòxihokóa\MC4
    \bits páó \cl taíta xah ákiih -h =kóa xah \cl ataxa kòxí -h -o =kóa 
    \gloss SS:AGENT COND TP:OBJECT see ST DECL TP:OBJECT CNTRF shoot FF FUT DECL
    \tr If you see them, I will shoot them
\end{examples}
\section{Verb phrase structure}
In the following section I will consider the structure of the verb phrase. I will begin by showcasing the roles of second-position clitics in the sections \ref{svspclitic}. Subsequently, I will schematize the function of particles in section \ref{svparticles}. At last, I will give a brief overview over adverbs and their syntactic role within the verb phrase complex.
\subsection{Second-position clitics}\label{svspclitic}
Second-position clitics are used to encode further verbal grammatical categories which are not marked on the verb stem directly. As their name suggests, they attach to the first element of the clause; an example for this behaviour can be seen in (\ref{ex:svspclitic1}).
\begin{examples}
    \newbaarucmd{\cl}{\baarujuncture{\texttt{==}}}
    \ex \label{ex:svspclitic1}
    \words tàahopíáki\MC2 pàah póhi táahi\MC2 kaihaokóa\MC2
    \bits tàahopí \cl áki pàah póhi tááh -i kaíhao =kóa 
    \gloss FAS:AGENT PERM water sacred drink DEP NEG DECL 
    \tr We weren't allowed to drink the holy water
\end{examples}
\subsection{Particles}\label{svparticles}
...
\section{Adverbs}\label{s:adverbs}
...
\chapter{Other Verbal Categories}\label{c:otherverb}
\section{Particles}
\subsection{PLACEHOLDER}
...
\subsection{PLACEHOLDER}
\subsection{Affixing Auxiliary Verbs}
\chapter{Derivation}
\section{Nominal}
